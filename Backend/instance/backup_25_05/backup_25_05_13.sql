...
SELECT pg_catalog.setval('public.hidden_articles_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.hidden_questions_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.refresh_id_seq', 4, true);
...
SELECT pg_catalog.setval('public.videos_id_seq', 90, true);
